...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildActionButton(
                        ...
                        onTap: () => _showRecordingSetupDialog(context),
                      ),
  ...
  // Show setup dialog before recording — collects topic and duration
  void _showRecordingSetupDialog(BuildContext context) {
